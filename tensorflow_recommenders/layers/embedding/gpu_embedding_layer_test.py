...
from tensorflow_recommenders.layers.embedding import gpu_embedding_layer
...
class GPUEmbeddingLayerTest(parameterized.TestCase, tf.test.TestCase):
  ...
  def _create_strategy_and_model(self,
    ...
    with strategy.scope():
      ...
      embedding_layer = gpu_embedding_layer.GPUEmbedding(
          feature_config=self.feature_config, optimizer=optimizer, embedding_feature=tf.tpu.experimental.HardwareFeature.EmbeddingFeature.GPU)
